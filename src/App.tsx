...
function App() {
  ...
  const [designDetailElems] = React.useState<DesignDetailsObj[]>([
...

    {
      ...
      paragraph1: 'We conducted observations and interviews with buyers inside of supermarkets to understand their buying habits and thought process. We also had co-creation sessions with stakeholders in Miro.',
      image1: roadmapEficacia,
      subtitle2: 'Design System',
      paragraph2: 'We created a design system for the mobile app, taking into account the brand colors and key functionalities the app would have. ',
      image2: userEficacia,
      subtitle3: 'Prototype',
