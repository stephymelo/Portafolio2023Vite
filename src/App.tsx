  ...
  const [designDetailElems] = React.useState<DesignDetailsObj[]>([
    {
      ...
      id: 0,
      title: 'Progen Global',
      subtitle: 'E-commerce website built with Shopify',
    ...
    },
    {
      ...
      id: 1,
      title: 'TressAllure',
      subtitle: 'B2B & B2C E-commerce built with Shopify',
      role: 'UX/UI, Project Manager',
      tasks: 'Branding, website development, managing team with Clickup.',
      tasks2: 'Shift the websites purpose to be both B2C and B2B ',
      ...
      paragraph1: 'TressAllure is a wholesale wig brand created in 2005.',
    ...
    },
    {
      ...
      tasks: 'Branding, website design, development, and customer experience optimization.',
      tasks2: 'Focused on creating an approachable and trustworthy platform for men and women experiencing hair loss.',
